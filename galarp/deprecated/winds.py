# These are old deprecated wind prescriptions that used an old "vector-first" format. The format now used in GalaRP
# is an "inclination-strength" format, which is FAR easier to use. These are just for reference and a JIC necessity.
